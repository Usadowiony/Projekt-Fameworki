    ...
    <section className="bg-white dark:bg-[#1b1d1f] h-full">
      <div className="container flex items-center justify-center h-full px-6 py-12 mx-auto">
        <form onSubmit={onSubmit} className="w-full max-w-md">
          ...
          {error && (
            <div className="flex w-full max-w-sm mt-6 overflow-hidden bg-white rounded-lg shadow-md dark:bg-[#121212]">
          ...
          <div className="relative flex items-center mt-4">
            ...
            <input 
              ...
              name="password"
              required
              className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-[#1b1d1f] dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" 
              placeholder="Hasło"
            />
          </div>
